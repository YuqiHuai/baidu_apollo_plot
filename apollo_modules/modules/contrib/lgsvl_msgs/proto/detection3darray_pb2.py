...
Detection3DArray = _reflection.GeneratedProtocolMessageType('Detection3DArray', (_message.Message,), {'DESCRIPTOR': _DETECTION3DARRAY, '__module__': 'modules.contrib.lgsvl_msgs.proto.detection3darray_pb2'})
_sym_db.RegisterMessage(Detection3DArray)
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    _DETECTION3DARRAY._serialized_start = 173
    _DETECTION3DARRAY._serialized_end = 290