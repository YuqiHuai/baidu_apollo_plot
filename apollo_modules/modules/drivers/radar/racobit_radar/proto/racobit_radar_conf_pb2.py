...
CanConf = _reflection.GeneratedProtocolMessageType('CanConf', (_message.Message,), {'DESCRIPTOR': _CANCONF, '__module__': 'modules.drivers.radar.racobit_radar.proto.racobit_radar_conf_pb2'})
_sym_db.RegisterMessage(CanConf)
RadarConf = _reflection.GeneratedProtocolMessageType('RadarConf', (_message.Message,), {'DESCRIPTOR': _RADARCONF, '__module__': 'modules.drivers.radar.racobit_radar.proto.racobit_radar_conf_pb2'})
_sym_db.RegisterMessage(RadarConf)
RacobitRadarConf = _reflection.GeneratedProtocolMessageType('RacobitRadarConf', (_message.Message,), {'DESCRIPTOR': _RACOBITRADARCONF, '__module__': 'modules.drivers.radar.racobit_radar.proto.racobit_radar_conf_pb2'})
_sym_db.RegisterMessage(RacobitRadarConf)
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    _OUTPUTTYPE._serialized_start = 1207
    _OUTPUTTYPE._serialized_end = 1315
    _RCSTHRESHOLD._serialized_start = 1317
    _RCSTHRESHOLD._serialized_end = 1420
    _CANCONF._serialized_start = 156
    _CANCONF._serialized_end = 338
    _RADARCONF._serialized_start = 341
    _RADARCONF._serialized_end = 1066
    _RACOBITRADARCONF._serialized_start = 1069
    _RACOBITRADARCONF._serialized_end = 1205