...
DaemonCmd = _reflection.GeneratedProtocolMessageType('DaemonCmd', (_message.Message,), {'DESCRIPTOR': _DAEMONCMD, '__module__': 'modules.dreamview.backend.teleop.proto.daemon_cmd_pb2'})
_sym_db.RegisterMessage(DaemonCmd)
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    _DAEMONCMD._serialized_start = 117
    _DAEMONCMD._serialized_end = 206